...
<section className=" py-10">
  <div className="container mx-auto px-4 bg-[#372011] rounded-md shadow-lg">
    <div className="flex flex-wrap items-center">
      {/* Left Side: Image */}
      <div className="w-full md:w-1/2 flex justify-center md:justify-end mb-6 md:mb-0">
        <Image src={foter} alt="logo" className="w-3/4 md:w-full " />
      </div>

      {/* Right Side: Text and Form */}
      <div className="w-full md:w-1/2 text-center md:text-left">
        <h3 className="text-lg md:text-2xl font-extrabold text-white mb-4 text-center md:text-end uppercase">
          Subscribe to Newsletters
        </h3>
        <p className="text-white mb-6 text-center md:text-end font-normal text-xs md:text-sm">
          Want to stay up to date? <br /> Sign up for our biannual updates.
        </p>
        <form className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-4 justify-center md:justify-end">
          <input
            type="email"
            placeholder=" email"
